  ...
  (function() {
    ...
    function loadPlugin() {
      ...
      if (initialise) {
        ...
        var showFullscreen = option(options.fullscreen, true);
        // var showOverview = option(options.overview, false);
        var showOverview = option(options.overview, true);
        var showPause = option(options.pause, false);
        var showNotes = option(options.notes, true);
        var showHelp = option(options.help, true);
